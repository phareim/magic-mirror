...
Module.register("music-player", {
	...
	getScripts: function() {
		return ["modules/mm-music-player/js/jquery.js",
			"modules/mm-music-player/js/jquery-ui.min.js"
		];
	},
	getStyles: function() {
		return ["style.css"];
	...
	getDom: function() {
		...
		getSongs(function(result) {
			...
			function next() {
				...
				$(audioElement).attr('src', 'modules/mm-music-player/music/' + songs[
					index]);
